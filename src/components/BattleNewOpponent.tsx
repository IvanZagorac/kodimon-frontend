...
function BattleNewOpponent (){
    ...
    const get1RandomAndWinnerPokemon=async ()=>{
        await Axios.get(config.pool+"pokemon/newOpponent")
            .then((res:any)=>{
                console.log(res.data)
                pokemon1Ref.current=res.data.pokemons[0];
                pokemon2Ref.current=res.data.pokemons[1];
                setImageURL(setPokemon1IMG,imagesPath+res.data.pokemons[0].url);
                setImageURL(setPokemon2IMG,imagesPath+res.data.pokemons[1].url);
    ...
    useEffect(()=>{
        void get1RandomAndWinnerPokemon();
                                ...
                                <Card.Footer >
                                    ...
                                    <Row>
                                        <Col className="dFlex" lg="6" md="6" sm="6" xs="12">
                                            <p>HP:{variablePokemon1HP}</p>
                                            <p>Attack:{pokemon1Ref.current.attack}</p>
                                        </Col>

                                        <Col className="dFlex" lg="6" md="6" sm="6" xs="12">
                                            <p>Defense:{pokemon1Ref.current.defense}</p>
                                            <p>Speed:{pokemon1Ref.current.speed}</p>
                                        </Col>
                                    </Row>
            ...
            >
                ...
                <ModalBody className="modalMeni">
                    <div className="modalMeniDiv" >
                        <Button className="meniBtn1" onClick={navigateToHome}>Home</Button>
                        <Button className="meniBtn2" onClick={navigateToBattle}>New Game</Button>
                        <Button className="meniBtn2" onClick={navigateToOwnPage}>New Opponent</Button>
                    </div>
                </ModalBody>
            </Modal>
        </Container>
...
export default BattleNewOpponent;